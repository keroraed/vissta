...
public sealed class VISSTADbContext(DbContextOptions<VISSTADbContext> options) : IdentityDbContext<ApplicationUser>(options)
{
    ...
    private static void SeedCatalog(ModelBuilder builder)
    {
        ...
        var products = new[]
        {
            ...
            new { Id = 10, Name = "Gold Edge Belt", Slug = "gold-edge-belt", Description = "Smooth leather, restrained hardware, precise finish.", Stock = 50, SKU = "VIS-ACC-BELT-001", CategoryId = 3, IsActive = true, IsFeatured = false, UnitsSold = 21, PriceAmount = 540m, Currency = "EGP" },
            new { Id = 11, Name = "Silk Pocket Square", Slug = "silk-pocket-square", Description = "A small flash of cream silk for considered outfits.", Stock = 60, SKU = "VIS-ACC-SILK-001", CategoryId = 3, IsActive = true, IsFeatured = false, UnitsSold = 17, PriceAmount = 320m, Currency = "EGP" },
            new { Id = 12, Name = "Heritage Tote", Slug = "heritage-tote", Description = "Structured canvas with navy trim and daily utility.", Stock = 12, SKU = "VIS-ACC-TOTE-001", CategoryId = 3, IsActive = true, IsFeatured = false, UnitsSold = 15, PriceAmount = 1250m, Currency = "EGP" }
        };
